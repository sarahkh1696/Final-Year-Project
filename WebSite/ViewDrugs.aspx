<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewDrugs.aspx.cs" Inherits="ViewDrugs" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <article class="auto-style10"> 
                 <asp:ListBox ID="lstDrugs" runat="server" OnSelectedIndexChanged="lstDrugs_SelectedIndexChanged" CssClass="auto-style9"></asp:ListBox>
