    ...
    <form id="form1" runat="server">
        ...
        <tr>
            <td class="auto-style5">
                <br />
                <br />
                <asp:Label ID="lblOrderID" runat="server" Text="Order ID:" Width="200px" CssClass="newStyle6"></asp:Label>
                <asp:TextBox ID="txtOrderID" runat="server" OnTextChanged="txtOrderID_TextChanged" CssClass="newStyle1" Width="174px"></asp:TextBox>
                <br />
                <asp:Label ID="lblPatientID" runat="server" Text="Patient ID:" Width="200px" CssClass="newStyle20"></asp:Label>
                <asp:TextBox ID="txtPatientID" runat="server" Width="174px"></asp:TextBox>
                <br />
                <asp:Label ID="lblDatePlaced" runat="server" Text="Date Placed:" Width="200px" CssClass="newStyle7"></asp:Label>
                <asp:TextBox ID="txtDatePlaced" runat="server" OnTextChanged="txtDatePlaced_TextChanged" CssClass="newStyle1" Width="174px"></asp:TextBox>
                <br />
                <asp:Label ID="lblQuantity" runat="server" Text="Quantity:" Width="200px" CssClass="newStyle19"></asp:Label>
                <asp:TextBox ID="txtQuantity" runat="server" Width="174px"></asp:TextBox>
                <br />
                <asp:Label ID="lblShippingAddress" runat="server" Text="Shipping Address:" Width="200px" CssClass="newStyle10"></asp:Label>
                <asp:TextBox ID="txtShippingAddress" runat="server" CssClass="newStyle1" Width="174px"></asp:TextBox>
                <br />
                <asp:Label ID="lblTotalPrice" runat="server" Text="Total Price:" Width="200px" CssClass="newStyle8"></asp:Label>
                <asp:TextBox ID="txtTotalPrice" runat="server" CssClass="newStyle1" Width="174px"></asp:TextBox>
                <br />
...
&nbsp;&nbsp;&nbsp;
 ...
 <nav class="auto-style2">
                ...
                <br />
                <br />
                <asp:LinkButton ID="LinkButton5" runat="server" CssClass="newStyle4" OnClick="LinkButton5_Click">View Orders</asp:LinkButton>
                <br />
                <br />
